...
SOURCES=$(OBJDIR)/zuon.o $(BUILDDIR)/lex.yy.c $(BUILDDIR)/zuon_grammar.tab.c $(SRCDIR)/tinysf.c $(SRCDIR)/common_functions.c $(SRCDIR)/symtab.c $(SRCDIR)/hashmap.c 
...
tester: $(SRCDIR)/tester.c $(SRCDIR)/tinysf.c
	gcc -g -o tester -I./$(INCDIR) $(SRCDIR)/tester.c $(SRCDIR)/tinysf.c
...
clean:
	rm -f $(TARGET) $(BUILDDIR)/* $(OBJDIR)/zuon.o tester
